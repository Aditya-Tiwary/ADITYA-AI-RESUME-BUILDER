...
const App = () => {
  ...
  const features = useMemo(
    () => [
      ...
      },
      {
        ...
        description:
          "Choose from expertly designed templates that showcase your experience and skills in the most professional way.",
        icon: (
          <svg
            className="w-16 h-16 text-white mb-4"
            fill="none"
  ...
  const testimonials = useMemo(
    () => [
      {
        quote:
          "I've recommended this AI Resume Builder to countless students. It helps them present their academic projects and skills professionally, making them stand out to employers.",
        author: "Anshuman Kumar Mishra",
        role: "Professor, Doranda College",
      },
      {
        quote:
          "This tool bridges the gap between academic learning and industry requirements. My students create impressive resumes that highlight their potential effectively.",
        author: "Balmant Kumar",
        role: "Professor, Doranda College",
      },
      {
        quote:
          "The AI-powered suggestions help students articulate their achievements clearly. It's an excellent resource for career preparation and professional development.",
        author: "Kundan Kumar",
        role: "Professor, Doranda College",
      },
    ],
  ...
  const handleGetStarted = useCallback(() => {
    alert("Start building your professional resume now!");
  }, []);
      ...
      <main className="container mx-auto px-4 py-8">
          ...
          {isLoaded && (
            ...
            >
              ...
              <div className="flex flex-col md:flex-row items-center relative z-10">
                ...
                >
                  <motion.div
                    className="flex flex-col items-start justify-start mb-4 mt-8"
                    initial={{ opacity: 0, y: 40 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8, delay: 0.5 }}
                  >
                    <div className="hidden lg:flex flex-row items-center gap-1 px-4 py-4 bg-gradient-to-r from-orange-600 to-orange-400 text-white rounded-full text-xl font-bold shadow-lg w-auto max-w-full overflow-hidden">
                      <img
                        src="/assets/Logo.png"
                        alt="Aditya Logo"
                        className="h-13 w-40 flex-shrink-0 object-contain"
                      />
                      <span className="text-4xl tracking-wider font-extrabold text-white ml-1 mt-2">
                        AI RESUME BUILDER
                      </span>
                    </div>

                    <div className="hidden md:flex lg:hidden flex-col items-center gap-1 px-3 py-3 bg-gradient-to-r from-orange-600 to-orange-400 text-white rounded-full shadow-lg w-auto max-w-full">
                      <img
                        src="/assets/Logo.png"
                        alt="Aditya Logo"
                        className="h-12 w-32 flex-shrink-0 object-contain"
                      />
                      <span className="text-3xl tracking-wider font-extrabold text-white text-center mt-1">
                        AI RESUME BUILDER
                      </span>
                    </div>

                    <div className="flex md:hidden flex-row items-center gap-1 px-3 py-3 bg-gradient-to-r from-orange-600 to-orange-400 text-white rounded-full shadow-lg w-auto max-w-full overflow-hidden">
                      <img
                        src="/assets/Logo.png"
                        alt="Aditya Logo"
                        className="h-10 w-24 flex-shrink-0 object-contain"
                      />
                      <span className="text-xl tracking-wider font-extrabold text-white ml-1 mt-1">
                        AI RESUME BUILDER
                      </span>
                    </div>
                  </motion.div>
          ...
          <div className="text-center mb-20 relative z-10">
            ...
            >
              ...
              <img
                src="/assets/Logo.png"
                alt="Aditya Logo"
                className="h-16 sm:h-20 md:h-24 lg:h-28 w-40 sm:w-48 md:w-56 lg:w-64 inline-block mx-2 object-contain"
              />
                ...
                <div className="relative bg-gradient-to-br from-teal-900/90 to-cyan-900/90 backdrop-filter backdrop-blur-xl p-6 md:p-8 lg:p-12 rounded-2xl h-full border border-teal-700/30">
                  <div className="flex flex-col h-full">
                    ...
                    <div className="flex items-center mt-auto">
                      <div className="w-16 h-16 bg-gradient-to-r from-orange-500 via-orange-400 to-cyan-500 rounded-full mr-4 sm:mr-5 flex items-center justify-center text-white font-bold text-xl shadow-xl ring-2 ring-cyan-400 ring-opacity-30 flex-shrink-0">
                        {testimonial.author.charAt(0)}
                      </div>
                      <div>
                        <p className="font-semibold text-white text-base sm:text-lg md:text-xl">
                          {testimonial.author}
                        </p>
        ...
        >
          ...
          <div className="relative z-10 text-center max-w-5xl mx-auto px-4">
            ...
            >
              Join thousands who transformed their careers with Aditya's
